...
goal = TestGoal()
# Indicates, move to waypoint number 1
goal.goal = 1

client.send_goal(goal, feedback_cb=feedback_callback)


# We can access the SimpleAction Variable "simple_state", that will be 1 if active, and 2 when finished.
# Its a variable, so we cam use a function like get_state.
